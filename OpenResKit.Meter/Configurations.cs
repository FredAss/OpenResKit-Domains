...
namespace OpenResKit.Meter
{
  ...
  public class MeterConfigurations : EntityTypeConfiguration<Meter>, IDomainEntityConfiguration
  {
  ...
  [Export(typeof (IDomainEntityConfiguration))]
  public class MeterReadingConfiguration : EntityTypeConfiguration<MeterReading>, IDomainEntityConfiguration
  {
    public void AddConfigurationToModel(ConfigurationRegistrar configurations)
    {
      configurations.Add(this);
